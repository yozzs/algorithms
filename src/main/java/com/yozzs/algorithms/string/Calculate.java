...
public class Calculate {
    ...
    public int calculate(String s) {
        ...
        return doCalculate(calculate(s1), calculate(s2), operator);
    }

    private int doCalculate(int var1, int var2, char operator){
        switch (operator){
